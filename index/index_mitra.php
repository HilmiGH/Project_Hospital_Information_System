...
<body>
    ...
    <div class="top_banner top_banner_mitra">
        <div>
    ...
    <div class="main">
        <div class="main_dashboard">
            <div class="button_base">
                <div class="dashboard_button dashboard_button_mitra">
            ...
            <div class="button_base">
                <div class="dashboard_button dashboard_button_mitra">
                    <a href="" class="button_clickable">
                        <div class="button_content">
                            <img class= "button_logo" src="images/dashboard_klaim_logo.png" alt="Logo Visite">
                        </div>
                        <div class="button_title">
                            Klaim
                        </div>
