...
<body>
    ...
    <div class="top_banner top_banner_pasien">
        <div>
        ...
        <div class="main_dashboard">
            <div class="button_base">
                <div class="dashboard_button dashboard_button_pasien">
                    <a href="buat_janji.php" class="button_clickable">
                        <div class="button_content">
                            <img class= "button_logo" src="images/dashboard_daftar_logo.png" alt="Logo Konsultasi">
                        </div>
