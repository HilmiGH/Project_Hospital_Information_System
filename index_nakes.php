...
<body>
    ...
    <div class="top_banner top_banner_nakes">
        <div>
    ...
    <div class="main">
        <div class="main_dashboard_4_tiles">
            ...
            <div class="button_base">
                <div class="dashboard_button dashboard_button_nakes">
                    <a href="pasien.php" class="button_clickable">
                        <div class="button_content">
                            <img class= "button_logo" src="images/dashboard_pasien_logo.png" alt="Logo Visite">
                        </div>
                        <div class="button_title">
                            Pasien
                        </div>
